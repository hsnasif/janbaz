...
<div class="topnav">
  <a href="signin.php">Seller Login</a>
...
<form action="signin_logic.php" method="post" class="container">
   ...
   <h1>Seller Login</h1>
    ...
    <input type="text" placeholder="Seller Email" name="selleremail" required>

    <label for="Password"><b>Password</b></label>
    <input type="password" placeholder="Enter Password" name="Password" required>

    <button type="submit" class="btn">Login to Seller Portal</button>
