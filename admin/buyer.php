...
<h2 style="color:#006600"> Buyer </h2> <a href="admin_pannel.php"> Back to Admin Pannel</a>
<div class="container">
...
<tr><td width="20%"> Buyer ID </td><td width="80%"><b><?php echo strtoupper($row['buyer_id']);?></b></td></tr>
<tr><td width="20%"> Buyer Name </td><td width="80%"><b><?php echo strtoupper($row['Buyer_Name']);?></b></td></tr>
